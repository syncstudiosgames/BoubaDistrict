...
El "Battle Pass" constará de 50 niveles y estará compuesto por un total de 60 regalos, repartidos entre todos los niveles. Un mismo nivel podrá ofrecer un regalo gratuito y otros de la línea de pago. El pase entregará a los jugadores los siguientes elementos:
...
## 9.3 Conclusión
En conclusión, el desarrollo Bouba Distric nos enseñó varias lecciones clave que guiarán nuestros futuros proyectos. Primero, la sincronización precisa entre música y mecánicas es esencial en juegos de ritmo, y la falta de experiencia en esta área nos llevó a enfrentar desafíos significativos. Ahora hemos adquirido conocimientos para mejorar esta sincronización en niveles futuros.

Además, la ausencia de una narrativa definida al comienzo del proyecto generó retrasos y decisiones forzadas en el diseño, afectando la cohesión del juego. En proyectos futuros, priorizaremos una planificación temática desde el principio para facilitar el desarrollo de mecánicas con mayor fluidez.

Por último, los problemas de escalabilidad en las interfaces 2D para dispositivos móviles nos impulsaron a rediseñar las pantallas con elementos 3D, logrando una mayor consistencia visual. Esta experiencia nos subraya la importancia de realizar pruebas tempranas de interfaz y ser flexibles ante cambios, adaptándonos a las limitaciones técnicas sin comprometer la experiencia del usuario, además de que en el camino encontramos la manera de poder usar interfaces 2D correctamente.
